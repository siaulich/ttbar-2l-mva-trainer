...
python scripts/EvaluateScript.py --load_config config/load_test_config.yaml --evaluation_config config/evaluate_assigner.yaml --output_dir plots/evaluate_assigner --ml_metrics
python scripts/EvaluateScript.py --load_config config/load_test_config.yaml --evaluation_config config/evaluate_accuracy.yaml --output_dir plots/compact_assigner --ml_metrics
