...
reconstruction_variable_configs = {
    ...
    "nu_mag": {
        ...
        "resolution": {
            "use_relative_deviation": True,
            "ylabel_resolution": r"Relative $E(\nu)$ Resolution",
            "ylabel_deviation": r"Mean Relative $E(\nu)$ Deviation",
        },
        "xlims": (0, 500),
        "bins": 20,
    },
    "nubar_mag": {
        ...
        "resolution": {
            "use_relative_deviation": True,
            "ylabel_resolution": r"Relative $E(\bar{\nu})$ Resolution",
            "ylabel_deviation": r"Mean Relative $E(\bar{\nu})$ Deviation",
        },
        "xlims": (0, 500),
        "bins": 20,
    },
    ...
    "nu_pt": {
        ...
        "resolution": {
            "use_relative_deviation": False,
            "ylabel_resolution": r"$p_{T}({\nu})$ Resolution [GeV]",
            "ylabel_deviation": r"Mean $p_{T}({\nu})$ Deviation [GeV]",
        },
    },
    "nubar_pt": {
        ...
        "resolution": {
            "use_relative_deviation": False,
            "ylabel_resolution": r"$p_{T}(\bar{\nu})$ Resolution [GeV]",
            "ylabel_deviation": r"Mean $p_{T}(\bar{\nu})$ Deviation [GeV]",
        },
    },
    "nu_eta": {
        ...
        "resolution": {
            "use_relative_deviation": False,
            "ylabel_resolution": r"$\eta({\nu})$ Resolution [GeV]",
            "ylabel_deviation": r"Mean $\eta({\nu})$ Deviation [GeV]",
        },
    },
    "nubar_eta": {
        ...
        "resolution": {
            "use_relative_deviation": False,
            "ylabel_resolution": r"$\eta(\bar{\nu})$ Resolution [GeV]",
            "ylabel_deviation": r"Mean $\eta(\bar{\nu})$ Deviation [GeV]",
        },
    },
    "nunubar_mag": {
