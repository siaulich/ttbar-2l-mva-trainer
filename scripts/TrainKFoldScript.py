...
if __name__ == "__main__":
    ...
    X_train, y_train, X_test, y_test = data_preprocessor.get_k_fold(
        n_folds=args.k_fold, k_fold_idx=args.k_fold_index
    )
    ...
    X_test, y_test, test_sample_weights = model.prepare_training_data(X_test, y_test)
    ...
    if args.event_numbers == "even":
        model_name = f"model_fold{fold_idx}_even"
    elif args.event_numbers == "odd":
        model_name = f"model_fold{fold_idx}_odd"
    else:
        model_name = f"model_fold{fold_idx}"
